...
impl crate::runtime::Runtime {
    ...
    pub fn profile_list(&self) -> Result<ags_protocol::output::ProfileView, RuntimeError> {
        use crate::runtime::config::{self, GlobalConfig};
        use ags_protocol::output::{ProfileSummary, ProfileView};
    ...
    pub fn profile_create(
        &self,
        name: &str,
    ) -> Result<ags_protocol::output::ProfileView, RuntimeError> {
        use crate::runtime::config;
        use ags_protocol::output::ProfileView;
    ...
    pub fn profile_show(
        ...
        use ags_protocol::output::{ProfileShowData, ProfileView};
    ...
    pub fn profile_delete(
        ...
        use crate::runtime::auth::store;
        use crate::runtime::config;
        use ags_protocol::output::{OperationWarning, ProfileView};
