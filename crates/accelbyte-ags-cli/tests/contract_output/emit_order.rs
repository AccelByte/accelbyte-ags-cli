...
use ags_protocol::result::{CommandResult, RawResult};

fn dummy_operation() -> ags_protocol::catalogue::OperationSchema {
    ags_protocol::catalogue::OperationSchema {
        id: ags_protocol::catalogue::OperationId::new("AdminListUsers"),
        name: "list".to_string(),
...
fn test_auth_login_success_is_stdout_first() {
    let output = CommandOutput::Auth(AuthOutput {
        view: AuthView::LoginSuccess(ags_protocol::output::AuthActionData {
            status: ags_protocol::output::AuthActionStatus::LoggedIn,
...
fn test_service_mutation_success_trace_before_data() {
    let output = CommandOutput::Service(Box::new(ApiOutput {
        operation: ags_protocol::catalogue::OperationSchema {
            id: ags_protocol::catalogue::OperationId::new("AdminCreateRole"),
            name: "create".to_string(),
            summary: "Create role".to_string(),
            description: None,
            mutation_class: ags_protocol::catalogue::MutationClass::Mutating,
            http_method: ags_protocol::catalogue::HttpMethod::Post,
