...
use ags::frontend::output::human::templates;
use ags::frontend::output::human::templates::render_error_text;
use ags_protocol::output::FieldEntry;
...
fn test_inspect_heading_with_fields_and_section() {
    use ags_protocol::output::Section;
