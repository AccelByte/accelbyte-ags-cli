...
fn test_iam_users_list_method_help() {
    ...
    Usage:
      ags iam users list-users-with-accelbyte-account [OPTIONS]
...
/// `auth refresh --help` shows the long_about explaining client-credentials vs
/// authorization-code routing and the "you may still need ags auth login" caveat
#[test]
...
fn test_leaf_help_single_scope_single_version() {
    ...
    Usage:
      ags iam bans bulk-ban-users [OPTIONS]
...
fn test_leaf_help_admin_only_multi_version() {
    ...
    Usage:
      ags iam roles add-permissions [OPTIONS]
