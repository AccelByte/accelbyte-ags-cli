...
pub(crate) fn handle_completions(
    ...
    let script = crate::invocation::completions_generator::generate_completion_script(shell);

    frontend.render(&CommandOutput::Completions(CompletionsOutput {
        script,
        hint,
    }))?;
